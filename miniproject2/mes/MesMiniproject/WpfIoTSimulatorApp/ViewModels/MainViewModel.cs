...
namespace WpfIoTSimulatorApp.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        public MainViewModel()
        {
            ...
            // MQTT용 초기화
            brokerHost = "210.119.12.55";   // 본인 PC 아이피
            clientId = "IOT55"; // IoT 장비번호
            mqttTopic = "pknu/sf55/data";   // 스마트팩토리 토픽
            logNum = 1; // 로그번호 1부터 시작
            // MQTT 클라이언트 생성 및 초기화
            InitMqttClient();
        ...
        public void Check()
        {
            ...
            // 일반 객체데이터를 json으로 변경 -> 직렬화(Serialization)
            ...
            LogText = $"MQTT 브로커 결과 메시지 전송 : {resultText}, {logNum++}";
        }
        #endregion
    }
}
